...
add_action('admin_head',function(){
	...
	#post_layout_options label input,#post_layout_options label input[type=radio]:checked:before{
		display:none;
	}

	<?php for ($i=1; $i<=3; $i++) { ?>

	#post_layout_options label input:checked {
...
add_filter('wpjam_post_options',function ($post_options){
	$post_options['layout-box'] = [
		...
		'fields'	=> [
			...
			'post_layout'		=>['title'=>'布局',			'type'=>'radio',	'options'=>['1'=>'','2'=>'','3'=>'']],
